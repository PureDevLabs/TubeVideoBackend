<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    @if (app(AuthSettings::class)->method == "oauth")
                        <x-jet-nav-link id="oauthNav" href="{{ route('oauth') }}" :active="request()->routeIs('oauth')">
                            {{ __('OAuth Management') }}
                        </x-jet-nav-link>
                    @endif
                    <x-jet-nav-link href="{{ route('cookies') }}" :active="request()->routeIs('cookies')">
                        {{ __('Cookie Management') }}
                    </x-jet-nav-link>
                    <x-jet-nav-link href="{{ route('dmca') }}" :active="request()->routeIs('dmca')">
                        {{ __('URL Blacklist') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('apimanagement') }}" :active="request()->routeIs('apimanagement')">
                {{ __('Api Management') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('cookies') }}" :active="request()->routeIs('cookies')">
                {{ __('Cookie Management') }}
            </x-jet-responsive-nav-link>
        </div>
